...
def forward_propagation(X, parametres_CNN, parametres_DNN, tuple_size_activation, dimensions_CNN, C_CNN, dimensions_DNN, C_DNN):
    ...
    activation_DNN = foward_propagation_DNN(A, parametres_DNN, dimensions_DNN, C_DNN)

    return activations_CNN, activation_DNN

def back_propagation(activation_DNN, activations_CNN, parametres_DNN, parametres_CNN, dimensions_CNN, tuple_size_activation, dimension_DNN, C_DNN, y_train):
    
    gradients_DNN, dZ = back_propagation_DNN(activation_DNN, parametres_DNN, dimension_DNN, y_train, C_DNN)
