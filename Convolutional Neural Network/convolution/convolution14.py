...
def initialisation_extraction(dimension, i):
    ...
    return k_size, stride, type_layer, fonction
...
def initialisation(x_shape0, dimension, padding):
    ...
    for i in range(1, len(dimension)+1):
        ...
        k_size, stride, type_layer, fonction = initialisation_extraction(dimension, i)
...
def main():
    ...
    dimensions = {"1" :(3, 1, "kernel", "relu"),
                  "2" :(2, 2, "pooling", "max"),
                  "3" :(3, 1, "kernel", "sigmoide")}

    x_shape0 = X.shape[0]
    parametres, parametres_grad, tuple_size = initialisation(x_shape0, dimensions, 0)
