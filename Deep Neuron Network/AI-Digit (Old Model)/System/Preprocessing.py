...
def preprocessing(X, y, input_shape, test_size=0.1):
    ...
    for i in range(1,16):
        plt.subplot(4,5, i)
        plt.imshow(X_train.reshape((X_train.shape[0], input_shape[1], input_shape[2]))[i], cmap="gray")
    ...
    for i in range(1,16):
        plt.subplot(4,5, i)
        plt.imshow(X_test.reshape((X_test.shape[0], input_shape[1], input_shape[2]))[i], cmap="gray")
